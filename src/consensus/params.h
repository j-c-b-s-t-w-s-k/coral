...
#ifndef CORAL_CONSENSUS_PARAMS_H
#define CORAL_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Coral Script solution
...
#endif // CORAL_CONSENSUS_PARAMS_H
