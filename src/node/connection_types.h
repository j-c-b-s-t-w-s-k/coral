...
#ifndef CORAL_NODE_CONNECTION_TYPES_H
#define CORAL_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/coral-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Coral’s Peer-to-Peer Network")
...
#endif // CORAL_NODE_CONNECTION_TYPES_H
