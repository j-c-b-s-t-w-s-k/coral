...
#ifndef CORAL_SCRIPT_STANDARD_H
#define CORAL_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a coral address
 */
...
/**
 * Generate a Coral scriptPubKey for the given CTxDestination. Returns a P2PKH
