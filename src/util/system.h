 ...
 */
#ifndef CORAL_UTIL_SYSTEM_H
#define CORAL_UTIL_SYSTEM_H
...
extern const char * const CORAL_CONF_FILENAME;
extern const char * const CORAL_SETTINGS_FILENAME;
