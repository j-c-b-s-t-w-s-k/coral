...
#ifndef CORAL_UTIL_SYSCALL_SANDBOX_H
#define CORAL_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during corald initialization if Coral Core was compiled
...
#endif // CORAL_UTIL_SYSCALL_SANDBOX_H
