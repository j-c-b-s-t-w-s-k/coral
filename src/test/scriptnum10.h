...
#ifndef CORAL_TEST_SCRIPTNUM10_H
#define CORAL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Coral Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CORAL_TEST_SCRIPTNUM10_H
