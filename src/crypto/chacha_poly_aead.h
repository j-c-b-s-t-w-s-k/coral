// Copyright (c) 2019-2021 The Coral Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CORAL_CRYPTO_CHACHA_POLY_AEAD_H
#define CORAL_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@coral.
 *
 ...
 *
 * The chacha20-poly1305@coral combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@coral cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@coral are relatively fast in
...
#endif // CORAL_CRYPTO_CHACHA_POLY_AEAD_H
