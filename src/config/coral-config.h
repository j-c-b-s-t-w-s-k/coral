/* src/config/coral-config.h.  Generated from coral-config.h.in by configure.  */
/* src/config/coral-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Coral Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Coral Core"
...
/* Define to 1 if you have the 'randomx' library (-lrandomx). */
#define HAVE_LIBRANDOMX 1
...
/* Define to 1 if you have the <randomx.h> header file. */
#define HAVE_RANDOMX_H 1
...
#define PACKAGE_BUGREPORT "https://github.com/coral/coral/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Coral Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Coral Core 24.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coral"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://coralcore.org/"
