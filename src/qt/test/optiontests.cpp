// Copyright (c) 2018 The Coral Core developers
...
{
    // Test regression https://github.com/coral/coral/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/coral-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/coral-core/gui/pull/568.
    // With fListen=false in ~/.config/Coral/Coral-Qt.conf and all else left as default,
    // coral-qt should set both -listen and -listenonion to false and start successfully.
