...
//! Entry point for CoralApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CoralApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CoralGUI tests.
void AppTests::guiTests(CoralGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CoralGUI::consoleShown, this, &AppTests::consoleTests);
