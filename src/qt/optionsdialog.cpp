    ...
    mapper(nullptr)
{
    ...
    ui->coralAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->coralAtStartup);
    ...
    ui->coralAtStartup->setToolTip(ui->coralAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->coralAtStartup->setText(ui->coralAtStartup->text().arg(PACKAGE_NAME));

    ui->openCoralConfButton->setToolTip(ui->openCoralConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CoralUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->coralAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCoralConfButton_clicked()
{
