...
#ifndef CORAL_QT_GUIUTIL_H
#define CORAL_QT_GUIUTIL_H
...
/** Utility functions used by the Coral Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "coral:" URI into recipient object, return true on successful parsing
