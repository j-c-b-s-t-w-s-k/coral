...
// Copyright 2015 Coral Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef CORAL_UNIVALUE_INCLUDE_UNIVALUE_H
#define CORAL_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // CORAL_UNIVALUE_INCLUDE_UNIVALUE_H
