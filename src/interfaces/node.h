...
#ifndef CORAL_INTERFACES_NODE_H
#define CORAL_INTERFACES_NODE_H
...
//! Top-level interface for a coral node (corald process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or coral.conf.
