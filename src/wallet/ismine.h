...
#ifndef CORAL_WALLET_ISMINE_H
#define CORAL_WALLET_ISMINE_H
 ...
 * https://github.com/coral/coral/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
