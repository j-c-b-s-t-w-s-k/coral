...
#ifndef CORAL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define CORAL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // CORAL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
