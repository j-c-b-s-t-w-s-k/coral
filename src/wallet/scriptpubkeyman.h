...
#ifndef CORAL_WALLET_SCRIPTPUBKEYMAN_H
#define CORAL_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Coral Core wallet was originally a collection of unrelated private
...
#endif // CORAL_WALLET_SCRIPTPUBKEYMAN_H
