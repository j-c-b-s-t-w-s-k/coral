...
#ifndef CORAL_WALLET_WALLETUTIL_H
#define CORAL_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! coral from opening the wallet, thinking it was newly created, and
...
#endif // CORAL_WALLET_WALLETUTIL_H
