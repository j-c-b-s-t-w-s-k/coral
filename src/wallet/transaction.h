...
#ifndef CORAL_WALLET_TRANSACTION_H
#define CORAL_WALLET_TRANSACTION_H
...
public:
     ...
     * on this coral node, and set to 0 for transactions that were created
...
#endif // CORAL_WALLET_TRANSACTION_H
