#!/usr/bin/env python3
# Copyright (c) 2018-2022 The Coral Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
#
# Be aware that corald and coral-qt differ in terms of localization: Qt
# opts in to POSIX localization by running setlocale(LC_ALL, "") on startup,
# whereas no such call is made in corald.
#
...
# C locale.
#
# In contrast, corald does not opt in to localization -- no call to
# setlocale(LC_ALL, "") is made and the environment variables LC_* are
# thus ignored.
#
# This results in situations where corald is guaranteed to be running
# with the classic locale ("C") whereas the locale of coral-qt will vary
# depending on the user's environment variables.
#
# An example: Assuming the environment variable LC_ALL=de_DE then the
# call std::to_string(1.23) will return "1.230000" in corald but
# "1,230000" in coral-qt.
#
