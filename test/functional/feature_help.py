...
"""Verify that starting coral with -h works as expected."""

from test_framework.test_framework import CoralTestFramework
from test_framework.util import assert_equal

class HelpTest(CoralTestFramework):
    ...
    def run_test(self):
        self.log.info("Start coral with -h for help text")
        ...
        self.log.info("Start coral with -version for version information")
        ...
        self.log.info("Start corald with -fakearg to make sure it does not start")
