...
By default, corald will dump mempool on shutdown and
...
class MempoolPersistTest(CoralTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent corald from writing mempool.dat to disk. Verify that `savemempool` fails")
