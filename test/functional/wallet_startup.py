#!/usr/bin/env python3
# Copyright (c) 2017-2020 The Coral Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test wallet load on startup.

Verify that a corald node can maintain list of wallets loading on startup
"""
...
class WalletStartupTest(CoralTestFramework):
