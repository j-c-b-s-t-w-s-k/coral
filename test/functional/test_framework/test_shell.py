...
class TestShell:
    """Wrapper Class for CoralTestFramework.

    The TestShell class extends the CoralTestFramework
    ...
    class __TestShell(CoralTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CoralTestFramework child class.
            self.num_nodes = 1
