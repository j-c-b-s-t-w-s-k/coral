...
class P2PPermissionsTests(CoralTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].coralconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].coralconf, 'w', encoding="utf8") as f:
            f.write(newText)
