...
Verify that a corald node can use an external signer command.
...
class RPCSignerTest(CoralTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart corald with -signer=<cmd>',
