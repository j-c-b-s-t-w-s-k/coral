...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/coral/coral/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(CoralTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our corald node")
