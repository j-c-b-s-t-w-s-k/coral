...
class RawTransactionsTest(CoralTestFramework):
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Coral address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/coral/coral/issues/20579)
