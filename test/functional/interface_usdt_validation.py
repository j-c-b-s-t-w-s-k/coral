...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/coral/coral/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(CoralTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/coral/coral/blob/master/doc/tracing.md#tracepoint-validationblock_connected
