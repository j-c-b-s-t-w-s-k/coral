...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CoralTestFramework
    pass


class ExampleTest(CoralTestFramework):
    # Each functional test is a subclass of the CoralTestFramework class.
    ...
    def custom_method(self):
        ...
        CoralTestFramework class so other tests can use it."""
