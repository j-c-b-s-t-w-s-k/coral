...
class TestCoralCli(CoralTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `coral-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and coral-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and coral-cli getwalletinfo return expected wallet info")
            ...
            # Test coral-cli -generate with -rpcwallet in multiwallet mode.
