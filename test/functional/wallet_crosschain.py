...
class WalletCrossChain(CoralTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].coralconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].coralconf, 'w', encoding='utf8') as conf:
