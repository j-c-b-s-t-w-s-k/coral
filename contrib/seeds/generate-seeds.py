...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef CORAL_CHAINPARAMSSEEDS_H\n')
    g.write('#define CORAL_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the coral network\n')
    ...
    g.write('#endif // CORAL_CHAINPARAMSSEEDS_H\n')
