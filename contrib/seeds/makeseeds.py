#!/usr/bin/env python3
# Copyright (c) 2013-2022 The Coral Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of coral node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple coral ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple coral ports', file=sys.stderr)
