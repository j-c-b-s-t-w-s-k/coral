...
"""Example logging Coral Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/corald
...
def main(corald_path):
    ...
    b = BPF(text=program, usdt_contexts=[corald_with_usdts])
