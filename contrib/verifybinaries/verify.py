...
"""Script for verifying Coral Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
coralcore.org and coral.org and compares them.
...
WORKINGDIR = "/tmp/coral_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://coralcore.org"
HOST2 = "https://coral.org"
VERSIONPREFIX = "coral-core-"
...
def main(args):
    ...
    if not success:
        print("coral.org failed to provide signature file, "
              "but coralcore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("coral.org and coralcore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Coral Core binary release "
